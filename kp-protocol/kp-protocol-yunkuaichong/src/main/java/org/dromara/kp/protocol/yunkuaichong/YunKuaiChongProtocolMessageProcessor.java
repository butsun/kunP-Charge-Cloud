...
import org.dromara.kp.infrastructure.util.JCPPPair;
...
import static org.dromara.kp.infrastructure.util.codec.ByteUtil.checkCrcSum;
...
public class YunKuaiChongProtocolMessageProcessor extends ProtocolMessageProcessor {
    ...
    public void uplinkHandle(ListenerToHandlerMsg listenerToHandlerMsg) {
        UUID msgId = listenerToHandlerMsg.getId();
        byte[] msg = listenerToHandlerMsg.getMsg();
        TcpSession session = (TcpSession) listenerToHandlerMsg.getSession();
    ...
    public void downlinkHandle(SessionToHandlerMsg sessionToHandlerMsg) {
        TcpSession session = (TcpSession) sessionToHandlerMsg.getSession();

        DownlinkRequestMessage protocolDownlinkMsg = sessionToHandlerMsg.getDownlinkMsg();
        ...
        if (! Objects.equals(protocolDownlinkMsg.getRequestIdMSB(),null) && ! Objects.equals(protocolDownlinkMsg.getRequestIdLSB(),null)) {
            message.setRequestId(new UUID(protocolDownlinkMsg.getRequestIdMSB(), protocolDownlinkMsg.getRequestIdLSB()));
        }

        if (! Objects.equals(protocolDownlinkMsg.getRequestData(),null)) {
            message.setRequestData(JacksonUtil.fromBytes(protocolDownlinkMsg.getRequestData(), YunKuaiChongUplinkMessage.class));
        }
